...
setting('bottom_filament_flow',     100., float, 'basic',    'Filament').setRange(1,300).setLabel("Bottom Flow (%)", "Flow compensation, the amount of material extruded is multiplied by this value")
...
settingsDictionary['bottom_filament_flow'].addCondition(lambda : getMachineSetting('gcode_flavor') != 'UltiGCode')
